...
export type IconName = 'send' | 'plus' | 'chat' | 'user' | 'kchat' | 'sun' | 'moon' | 'chip' | 'chevron-down' | 'edit' | 'delete' | 'search' | 'menu' | 'panel-left-close' | 'folder' | 'folder-plus' | 'paperclip' | 'close' | 'file' | 'settings' | 'download' | 'upload' | 'language' | 'tools' | 'code' | 'link' | 'stop' | 'brain' | 'copy' | 'regenerate' | 'users' | 'archive' | 'unarchive' | 'eye' | 'volume-2' | 'clipboard' | 'arrow-left-right' | 'history' | 'translate-logo' | 'swap-horizontal' | 'info' | 'check-circle' | 'alert-circle' | 'graduation-cap' | 'gift' | 'bug' | 'message-square' | 'github' | 'check';
